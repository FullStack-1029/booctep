...
from home.views import home_view, signup,loginn, about, faqs, help, terms, become,become_a_teacher,single_category, searching,single_course, register_user, activation, logout_,ecommerce_cart,ecommerce_payment, getPromoData
from home.views import *
from student.views import options_settings, transaction, account, courses, options_settings, security, payments, privacy, quizes, quizes2, certificates,viewcertificates, PurchaseHistory, student_messages, student_notifications,student_cart
...
urlpatterns += i18n.i18n_patterns(
    ...
    url(r'^become_a_teacher/$', become_a_teacher, name='become_a_teacher'),
	...
	url(r'^category/(?P<id>[0-9]+)/$', single_category, name='single_category'),
	
	
	# url(r'^single_course/(?P<id>[0-9]+)/$', single_course, name='single_course'), 
    url(r'^course/(?P<course_url>\w+)/$', single_course, name='single_course'),
    ...
    url(r'^teacher/payout/$', payout, name='teacher payout method'),

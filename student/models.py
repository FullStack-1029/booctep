...
class student_rating_courses(models.Model):
	student_id = models.ForeignKey(User, on_delete=models.CASCADE,null = True,related_name='rating_user')
	course_id = models.ForeignKey(Courses, on_delete=models.CASCADE,null = True,related_name='rating_course')
...
class student_certificate(models.Model):
	...
	# student_id = models.IntegerField(null=True, max_length=11)
	# course_id = models.IntegerField(null=True, max_length=11)
